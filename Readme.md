...
5. **API endpoints results:**

After creating or updating the Workflow YAML and executing the workflow
...
```bash
curl -X GET http://localhost:3000/workflow/383e3492-2ac5-4f41-bf9c-382af6e22a63/status
```

Result:

```javascript
{"workflowId":"383e3492-2ac5-4f41-bf9c-382af6e22a63","status":"completed","completed":4,"totalNumberOfTasks":4}
```
...
```bash
curl -X GET http://localhost:3000/workflow/383e3492-2ac5-4f41-bf9c-382af6e22a63/results
```

Result:

```javascript
    {"workflowId":"383e3492-2ac5-4f41-bf9c-382af6e22a63","status":"completed","finalResult":"[{},\"Brazil\",{},{}]"}
```
